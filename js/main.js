...
(function ($) {
    ...
    $(function () {
        ...
        //project Title Slide start
        var $titleSlideList01 = $('.project .project_inner.type01 .title_slide_list');
        $titleSlideList01.each(function(){
            var $this = $(this);
            $this.slick({
                autoplay : true,
                autoplaySpeed : 0,
        ...
        //project Title Slide end

        //mainLayout GSAP start
        function gsapInit(){
            gsap.registerPlugin(ScrollTrigger);
            ScrollTrigger.matchMedia({
                '(min-width:1001px)' : function () {
                    //rowgroup1 ele start
                    gsap.to($('.rowgroup1 .fix_line .fix_line_path'), {
                        scrollTrigger : {
                            trigger : $('#wrapper'),
                            start : '0% 0%',
                            end : '100% 100%',
                    ...
                    gsap.to($('.rowgroup1 .line_vertical_text span:nth-child(2n-1) em'), {
                        scrollTrigger : {
                            trigger : $('#wrapper'),
                            start : '0% 0%',
                            end : '100% 100%',
                    ...
                    gsap.to($('.rowgroup1 .line_vertical_text span:nth-child(2n) em'), {
                        scrollTrigger : {
                            trigger : $('#wrapper'),
                            start : '0% 0%',
                            end : '100% 100%',
                    ...
                    //rowgroup2 ele start
                    gsap.to($('.rowgroup2 .profile .profile_inner.type01 .me'), {
                        scrollTrigger : {
                    ...
                    gsap.to($('.rowgroup2 .profile .profile_inner.type01 .me .deco.type01'), {
                        scrollTrigger : {
                            trigger : $('.rowgroup2 .profile'),
                            start : '0% 0%',
                            end : '100% 0%',
                    ...
                    gsap.to($('.rowgroup2 .profile .profile_inner.type01 .me .deco.type02'), {
                        scrollTrigger : {
                            trigger : $('.rowgroup2 .profile'),
                            start : '5% 0%',
                            end : '100% 0%',
                    ...
                    gsap.to($('.rowgroup2 .profile .profile_inner.type01 .me .me_inner .characterization'), {
                        scrollTrigger : {
                            trigger : $('.rowgroup2 .profile'),
                            start : '5% 0%',
                            end : '100% 0%',
                            ...
                            onUpdate : function(self) {
                                ...
                                $('.profile .profile_inner.type01 .me .me_inner .characterization').css({
                                    'clip-path':'circle('+circle+'% at 50% 50%)',
                                    'shape-outside':'circle('+circle+'% at 50% 50%)'
                                });
                            }
                        },
                        rotate : '90deg'
                    });
                    gsap.to($('.rowgroup2 .profile .profile_inner.type02 .back_img'), {
                        scrollTrigger : {
                            ...
                            onUpdate : function(self) {
                                ...
                                $('.profile .profile_inner.type02 .back_img').css({
                                    'clip-path':'circle(7.5vw at 87.6vw '+circle+'%)',
                                    'filter':'hue-rotate('+hueRotate+'deg)'
                                });
                            }
                        }
                    });
                    gsap.to($('.rowgroup2 .profile .profile_inner.type02 .since'), {
                        scrollTrigger : {
                            trigger : $('.rowgroup2 .profile_inner.type01'),
                            start : '20% 0%',
                            end : '100% 0%',
                    ...
                    gsap.to($('.rowgroup2 .profile .profile_inner.type02 .company'), {
                        scrollTrigger : {
                            trigger : $('.rowgroup2 .profile_inner.type01'),
                            start : '40% 0%',
                            end : '100% 0%',
                    ...
                    gsap.to($('.rowgroup2 .profile .profile_inner.type02 .job'), {
                        scrollTrigger : {
                            trigger : $('.rowgroup2 .profile_inner.type01'),
                            start : '60% 0%',
                            end : '100% 0%',
                    ...
                    gsap.to($('.rowgroup2 .profile .profile_inner.type02 .intro'), {
                        scrollTrigger : {
                            trigger : $('.rowgroup2 .profile_inner.type01'),
                            start : '80% 0%',
                            end : '100% 0%',
                        ...
                        scrollTrigger : {
                            ...
                            onUpdate : function(self) {
                                ...
                                $('.rowgroup3 .project .project_inner.type01').css({
                                    'clip-path':'circle('+circle+'% at 100% 50%)',
                                });
                            }
                        },
                        rotateY : '-45deg',
                    ...
                    gsap.to($('.rowgroup3 .project .project_inner.type01 .title_slide_list'), {
                        scrollTrigger : {
                            trigger : $('.rowgroup3 .project .project_inner.type02'),
                            start : '0% 0%',
                            end : '100% 0%',
                    ...
                    var $infoList = $('.rowgroup3 .project .project_inner.type02 .info_box .info_box_inner .info_list');
                    ...
                    $infoItem.each(function(){
                        var $this = $(this);
                        gsap.to($this.find('.site_capture_inner em'), {
                            scrollTrigger : {
                                trigger : $this,
                                start : '-40% 0%',
                                end : '100% 0%',
                        ...
                        var proxy = { skew : 0 };
                        var skewSetter = gsap.quickSetter($this, 'skewY', 'deg');
